...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_frac', type=float, default=0.6, help='fraction of the dataset used as a training set')

    # the following two defaults are optimal for K=10, p=0.5, s=100
    parser.add_argument('--bagging_frac', type=float, default=0.8, help='fraction of the training set sampled for each bag')
